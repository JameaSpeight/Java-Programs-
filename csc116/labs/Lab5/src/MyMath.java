...
public class MyMath {
    ...
    public static void main(String[] args) {
		System.out.println(min(2, 4, 6)); // EXPECTED OUTPUT: 2.0
		System.out.println(max(2, 4, 6)); // EXPECTED OUTPUT: 6.0
		System.out.println(average(2, 4, 10));// EXPECTED OUTPUT: 5.333333333333
    ...
    public static double min(double a, double b, double c) {
        ...
        double finalMin = Math.min(minAB,c);
        return finalMin;
    }
    ...
    public static double max(double a, double b, double c) {
        ...
        double finalMax = Math.max(maxAB,c);
        return finalMax;
    }
