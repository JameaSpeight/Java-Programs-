...
public class SomewhatMoreSimplifiedSolitaire {
    ...
    public static String moveFirstJokerDownOne(String deck) {
        ...
        if (indexOfJokerA < deck.lastIndexOf(" ")) {
            ...
            String firstCardOfDeck = deck.substring(0, deck.indexOf(" "));
            String firstHalfOfDeck = deck.substring(0, deck.lastIndexOf(" "));
            String firstHalfOfDeckWithoutFirstCard = firstHalfOfDeck
                    .substring(firstHalfOfDeck.indexOf(" ") + 1);
            return JOKER_A + " " + firstHalfOfDeckWithoutFirstCard + " " + firstCardOfDeck;
        }
    }
